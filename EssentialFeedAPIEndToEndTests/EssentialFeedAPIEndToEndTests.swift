...
//
//  Created by Ali Elsokary on 24/11/2021.
//  
//
...
class EssentialFeedAPIEndToEndTests: XCTestCase {
	...
	private func gotFeedResult(file: StaticString = #filePath, line: UInt = #line) -> Swift.Result<[FeedImage], Error>? {
